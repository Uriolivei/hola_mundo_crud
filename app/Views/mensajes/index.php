    ...
    <div class="grid">
      <?php foreach ($mensajes as $m): ?>
        <article class="card">
          ...
          <div class="row">
            <a class="btn" href="<?= (BASE_URL ? rtrim(BASE_URL,'/') : '') ?>/mensajes/show?id_mensaje=<?= (int)$m['id_mensaje'] ?>">Ver</a>
            <a class="btn secondary" href="<?= (BASE_URL ? rtrim(BASE_URL,'/') : '') ?>/mensajes/edit?id_mensaje=<?= (int)$m['id_mensaje'] ?>">Editar</a>
          </div>
        </article>
      <?php endforeach; ?>
    </div>
